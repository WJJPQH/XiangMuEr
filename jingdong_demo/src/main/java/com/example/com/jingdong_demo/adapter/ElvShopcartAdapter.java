...
import com.example.com.jingdong_demo.shop.ShopPresenter;
import com.example.com.jingdong_demo.utils.SharedPreferencesUtils;
import com.example.com.jingdong_demo.widget.AddSubView;
...
public class ElvShopcartAdapter extends BaseExpandableListAdapter {
    ...
    private ShopPresenter shopcartPresenter;

    public ElvShopcartAdapter(Context context, List<SellerBean> groupList, List<List<GetCartsBean.DataBean.ListBean>>
            childList, ShopPresenter shopcartPresenter, ProgressDialog progressDialog) {
